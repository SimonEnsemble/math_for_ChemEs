...
\begin{multicols}{2}
	...
	our goal is to model the difference in the liquid level between the two sides of the tube $h=h(t)$ [m]. by convention, $h>0$ implies the liquid level is lower on the left side.
